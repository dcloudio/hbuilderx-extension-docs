...
4. 账户服务
在本软件提供的账户服务被使用时（可选），包括不限于登陆、注册、密码找回、捐赠、同步、账户周边信息查询、创建和分配appid等功能时，会连接DCloud服务器。
5. 用户意见反馈
...
您使用DCloud开发工具的信息默认情况下不视为保密信息，DCloud可能会在案例文档中列出您的应用。如果您不便公开相关信息，请联系service@dcloud.io声明。

## 安全
您理解并同意，本软件同其他软件一样，无法承诺绝对的安全性。
维护软件安全与正常使用是DCloud和您的共同责任，您应加强信息安全及个人信息的保护意识，注意密码保护，以免遭受损失。

DCloud已经获取了中华人民共和国国家信息安全等级保护三级，DCloud将按照标准提供安全措施。包括但不限于不明文存储密码、身份证号码等敏感信息。

当DCloud发现本软件的任何安全漏洞时，将及时发布紧急更新补丁和升级推送通知。
