...
* cli 命令
    ...
    * [打開文件](/cli/file.md)
    * [uni-app 發行 - Android/iOS 雲打包](/cli/pack.md)
    * [uni-app 發行 - App 生成本地打包資源](/cli/publish-app-appResource.md)
    * [uni-app 發行 - 鴻蒙-本地打包](/cli/pack-app-harmony.md)
    * [uni-app 發行 - 鴻蒙-生成本地打包資源](/cli/publish-app-harmony.md)
    * [uni-app 發行 - App 製作應用 wgt 包](/cli/publish-app-wgt.md)
    * [uni-app 發行 - WEB](cli/publish-h5.md)
    * [uni-app 發行 - 小程序](cli/publish-miniProgram.md)
    * [uni-app 發行 - 鴻蒙元服務打包](/cli/pack-mp-harmony.md)
    * [uni-app 運行日誌 - 手機或模擬器](cli/logcat-app.md)
    * [uni-app 運行日誌 - WEB](cli/logcat-web.md)
    * [uni-app 運行日誌 - 小程序](cli/logcat-miniProgram.md)
    * [uni-app 運行日誌 - uniCloud](cli/logcat-unicloud.md)
    * [獲取設備列表](/cli/devices-list.md)
    * [uniCloud](/cli/uniCloud.md)
    * [前端網頁託管](/cli/uniCloud-hosting.md)
    * [uni_modules](/cli/uniModules.md)
* 擴展
    * [配置環境變量](/cli/env.md)
    * [Linux 安裝插件市場插件](/cli/linux-install-market-plugin.md)
