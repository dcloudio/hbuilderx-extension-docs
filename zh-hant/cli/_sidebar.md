...
* cli命令
    ...
    * [打開文件](/cli/file.md)
    * [uni-app 發行 - Android/iOS 云打包](/cli/pack.md)
    * [uni-app 發行 - App 生成本地打包资源](/cli/publish-app-appResource.md)
    * [uni-app 发行 - 鸿蒙-本地打包](/cli/pack-app-harmony.md)
    * [uni-app 发行 - 鸿蒙-生成本地打包资源](/cli/publish-app-harmony.md)
    * [uni-app 發行 - App 制作应用wgt包](/cli/publish-app-wgt.md)
    * [uni-app 發行 - WEB](cli/publish-h5.md)
    * [uni-app 發行 - 小程序](cli/publish-miniProgram.md)
    * [uni-app 發行 - 鸿蒙元服务打包](/cli/pack-mp-harmony.md)
