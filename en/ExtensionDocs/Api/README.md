...
|hx.languages.registerInlineCompletionItemProvider()|Register an inline code completion provider [Details](/ExtensionDocs/Api/languages/registerInlineCompletionItemProvider)																																						|
...
|hx.window.createStatusBarItem()			|Create a status bar item [Details](/ExtensionDocs/Api/windows/createStatusBarItem)										|
