...
* Fixed the false-positive CSS validation errors in uni-app x projects introduced in version 5.11 of the language service. [Details](https://issues.dcloud.net.cn/pages/issues/detail?id=29657)
